...
- Every push to `main` replaces the full GitHub release tagged `nightly`. Its timestamped version is recorded in the release notes; nightlies are retained on GitHub only and are never uploaded to Steam.
